...
// para o backend FastAPI (default localhost:8415), mantendo same-origin
...
const BACKEND = process.env.VITE_BACKEND_URL || 'http://127.0.0.1:8415'
...
export default defineConfig({
  ...
  server: {
    port: 5185,
    proxy: {
      // changeOrigin:false preserva o Host do navegador (localhost:5185). Assim,
