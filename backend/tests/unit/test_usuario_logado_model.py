...
class TestIsVendedor:
    """Testes para o método is_barbearia() (perfil Barbearia, segundo perfil
    distinto de Cliente). Nome de classe legado mantido para compatibilidade."""

    def test_vendedor_retorna_true(self):
        """Usuário com perfil Barbearia deve retornar True"""
        vendedor = UsuarioLogado(
            id=1,
            nome="Barbearia",
        ...
        assert vendedor.is_barbearia() is True

    def test_admin_retorna_false(self):
        """Admin não deve ser barbearia"""
        admin = UsuarioLogado(
            id=1,
            nome="Admin",
            email="admin@teste.com",
        ...
        assert admin.is_barbearia() is False

    def test_cliente_retorna_false(self):
        """Cliente não deve ser barbearia"""
        cliente = UsuarioLogado(
            id=1,
            nome="Cliente",
            email="cliente@teste.com",
        ...
        assert cliente.is_barbearia() is False
