...
from routes.admin_barbearias_routes import router as admin_barbearias_router
from routes.barbearias_routes import router as barbearias_router
from routes.agendamentos_routes import router as agendamentos_router
...
# ---------------------------------------------------------------------------
# Garante o MIME correto de imagens .webp (ausente no Python slim do container,
# onde o StaticFiles serviria as fotos como text/plain).
...
ROUTERS = [
    ...
    (admin_estatisticas_router, ["Admin - Estatísticas"], "admin de estatísticas"),
    (admin_barbearias_router, ["Admin - Barbearias"], "admin de barbearias"),
