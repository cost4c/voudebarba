...
async def criar(
    ...
    # Foto de perfil opcional enviada no cadastro.
    if dto.foto_base64:
        try:
            salvar_foto_cropada_usuario(usuario_id, dto.foto_base64)
        except (ValueError, IOError, OSError) as e:
            logger.warning(f"Falha ao salvar foto do usuário {usuario_id}: {e}")
