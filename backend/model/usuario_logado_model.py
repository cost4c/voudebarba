...
class UsuarioLogado:
    ...
    def is_barbearia(self) -> bool:
        """Verifica se o usuário é dono/gestor de barbearia."""
        return self.perfil == Perfil.BARBEARIA.value
    ...
    def tem_perfil(self, *perfis: str) -> bool:
        ...
        Exemplo:
            if usuario.tem_perfil(Perfil.ADMIN.value, Perfil.BARBEARIA.value):
                # lógica para admin ou barbearia
        """
